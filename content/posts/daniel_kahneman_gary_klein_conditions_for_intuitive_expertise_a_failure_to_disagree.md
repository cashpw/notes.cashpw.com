...
lastmod = 2023-09-24T10:04:17-07:00
...
[Daniel Kahneman]({{< relref "daniel_kahneman_gary_klein_conditions_for_intuitive_expertise_a_failure_to_disagree.md" >}}), [Gary Klein]({{< relref "daniel_kahneman_gary_klein_conditions_for_intuitive_expertise_a_failure_to_disagree.md" >}}), (<a href="#citeproc_bib_item_1">Kahneman and Klein 2009</a>)


## Summary {#summary}

-   [Naturalistic decision making]({{< relref "naturalistic_decision_making.md" >}}) focuses on the successes of expert intuition while [Heuristics and biases]({{< relref "heuristics_and_biases.md" >}}) favors a skeptical attitude
-   Development of reliable, measurable, expertise requires a [Kind environment]({{< relref "kind_environemnt.md" >}}) and sufficient time to develop the skill. Some domains are more auspicious than others.
...
#### Origins of the [Heuristics and biases]({{< relref "heuristics_and_biases.md" >}}) approach {#origins-of-the-heuristics-and-biases--heuristics-and-biases-dot-md--approach}
...
### Contrasts between the naturalistic decision making and heuristics and biases approaches {#contrasts-between-the-naturalistic-decision-making-and-heuristics-and-biases-approaches}


#### Stance regarding expertise and decision algorithms {#stance-regarding-expertise-and-decision-algorithms}
...
#### Skilled intuition as recognition {#skilled-intuition-as-recognition}
...
See also [Cedric Chin | Expertise Is 'Just' Pattern Matching]({{< relref "chinExpertiseJustPatternMatching2020.md" >}}).

> In other environments, the regularities that can be observed are misleading. Hogarth (2001) introduced the useful notion of wicked environments [[Wicked environment]({{< relref "wicked_environment.md" >}})], in which wrong intuitions are likely to develop. His most compelling example (borrowed from Lewis Thomas) is the early 20th century physician who frequently had intuitions about patients in the ward who were about to develop typhoid. He confirmed his intuitions by palpating these patients' tongues, but because he did not wash his hands the intuitions were disastrously self-fulfilling.
