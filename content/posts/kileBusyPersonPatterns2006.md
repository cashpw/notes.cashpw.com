...
lastmod = 2023-12-05T20:28:06-08:00
...
This isn't the first time I've seen these concepts (e.g. [Deep work]({{< relref "deep_work.md" >}}) and [Contiguous Time Blocks](#contiguous-time-blocks) / [Single-Task Important Items](#single-task-important-items); [Agile]({{< relref "agile.md" >}}) and [Feedback Loop](#feedback-loop)) which gives me greater confidence in their profundity. It may be trite to say you should [Just Start](#just-start) or to [Drop Unimportant Tasks](#drop-unimportant-tasks); however, these simple truths are still true and I often forget them.
...
-  Commentary
    ...
    > This pattern is different from [Contiguous Time Blocks](#contiguous-time-blocks). [Single-Task Important Items](#single-task-important-items) does not refer to blocking off time for a task, but refers to concentration on a single important task at a time.
...
-  Resulting Context
    ...
    > Perhaps the most harmful alternative resulting context for this pattern is if you decide to batch simple stuff instead of completing larger and more important tasks. Though you may gain some satisfaction in completing these smaller items, when a task is unimportant, you should consider using a [Task Jar](#task-jar) instead.
...
-  Commentary
    ...
    -   Tasks should be well known; no need to [Seek Clarification](#seek-clarification)
    -   Related:
        -   [Batch the Simple Stuff](#batch-the-simple-stuff)
...
Related: [Drop Unimportant Tasks](#drop-unimportant-tasks)
...
> -   When you are busy, you cannot complete every task assigned to you and may need to [Drop Unimportant Tasks](#drop-unimportant-tasks).
>
