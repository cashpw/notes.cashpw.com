...
lastmod = 2023-12-05T14:19:29-08:00
...
A great guide to writing in [Julian Shapiro]({{< relref "julian_shapiro.md" >}})'s style. It overlaps well with my own [Style Guide]({{< relref "style_guide.md" >}}).
...
See also [Collaborate for better results]({{< relref "collaborate_for_better_results.md" >}}).
