...
lastmod = 2023-12-21T20:42:49-08:00
...
> Dijkstra's algorithm [[Dijkstra's algorithm]({{< relref "a_star_algorithm.md" >}})], as another example of a uniform-cost search algorithm, can be viewed as a special case of A\* where \\(h(x) = 0\\) for all \\(x\\).
>
> (<a href="#citeproc_bib_item_1">“A* Search Algorithm” 2022</a>)

Like [Dijkstra's algorithm]({{< relref "a_star_algorithm.md" >}}), A\*'s implementation uses [Dynamic programming]({{< relref "a_star_algorithm.md" >}}).
...
-   [Branch and bound]({{< relref "a_star_algorithm.md" >}})
-   [Dijkstra's algorithm]({{< relref "a_star_algorithm.md" >}})
-   [Dynamic programming]({{< relref "a_star_algorithm.md" >}})
-   [Shortest path algorithm]({{< relref "a_star_algorithm.md" >}})
-   [Single-pair shortest path problem]({{< relref "a_star_algorithm.md" >}})
-   [Single-source shortest path problem]({{< relref "a_star_algorithm.md" >}})
-   [Topological order]({{< relref "a_star_algorithm.md" >}})
