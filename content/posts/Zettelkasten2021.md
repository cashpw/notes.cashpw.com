...
lastmod = 2023-12-21T20:42:28-08:00
...
>
> A zettelkasten may be created and used in a [digital format]({{< relref "Zettelkasten2021.md" >}}), sometimes using personal knowledge management software. But it can be and has long been done on paper using index cards.
>
...
Related: [Personal knowledge management]({{< relref "Zettelkasten2021.md" >}})
...
-   [Andy Matuschak]({{< relref "Zettelkasten2021.md" >}})
-   [Examples of Zettelkasten Notes]({{< relref "Zettelkasten2021.md" >}})
-   [README]({{< relref "Zettelkasten2021.md" >}})
-   [Style Guide]({{< relref "Zettelkasten2021.md" >}})
