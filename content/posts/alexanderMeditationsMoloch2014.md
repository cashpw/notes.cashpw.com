...
Systems compel the individuals within them to act within the rules of the system rather than by a [globally optimal]({{< relref "global_maxima.md" >}}) set of rules.
